    ...
    <section className="relative w-full overflow-hidden bg-[#030712]">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-32 lg:py-40">
        <div className="max-w-5xl mx-auto text-center animate-fade-in">
          ...
          <div className="bg-[#0b1c4a] rounded-2xl md:rounded-3xl p-5 md:p-8 mb-6 md:mb-12 max-w-2xl mx-auto border border-white/10">
            <div className="flex flex-row items-center justify-between gap-4 md:gap-6">
              <div className="flex items-center gap-3 md:gap-4 text-left">
                ...
                <div>
                  <div className="text-2xl md:text-4xl font-black font-display text-white leading-none mb-1">
                    10 000+
                  </div>
                  <p className="text-xs md:text-base text-white/60 font-medium">
                    довольных пользователей с нами
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-6 max-w-4xl mx-auto">
            <div className="bg-[#0b1c4a] rounded-2xl md:rounded-3xl p-5 md:p-8 border border-white/10 hover:border-[#0047ff]/60 hover:-translate-y-1 transition-all duration-300 group">
              <div className="flex flex-col items-center text-center h-full">
                ...
                <p className="text-white/55 text-xs md:text-base mb-4 md:mb-6 flex-grow">
                  Свыше 5188 игр в коллекции
                </p>
                <Link
                  href="/games"
                  className="bg-[#0047ff] hover:bg-[#0033b7] text-white px-4 py-2.5 md:py-3.5 rounded-xl text-sm md:text-lg font-bold w-full transition-all duration-200 shadow-lg shadow-[#0047ff]/25"
                >
                  Смотреть
                </Link>
              </div>
            ...
            <div className="bg-[#0b1c4a] rounded-2xl md:rounded-3xl p-5 md:p-8 border border-white/10 hover:border-[#fcc000]/60 hover:-translate-y-1 transition-all duration-300 group">
              <div className="flex flex-col items-center text-center h-full">
                ...
                <p className="text-white/55 text-xs md:text-base mb-4 md:mb-6 flex-grow">
                  PS Plus и EA Play по низкой цене
                </p>
                <Link
                  href="/subscription"
                  className="bg-[#fcc000] hover:bg-[#d9a800] text-[#1a1302] px-4 py-2.5 md:py-3.5 rounded-xl text-sm md:text-lg font-bold w-full transition-all duration-200 shadow-lg shadow-[#fcc000]/25"
                >
                  Подключить
                </Link>
              </div>
